...
1.) The first part of the code prepares the input data (1_import_data) for
    the following GLM analysis by:
        a) Eliminating all rows below 100 ha.
        b) Combining AEZ classes, filling or eliminating missing data.
        c) Eliminating outliers.
        d) Replacing no data values in the continent column.
...
2.) The second part calculates descriptive statistics for each step of the
    data cleaning process and saves them to file.
