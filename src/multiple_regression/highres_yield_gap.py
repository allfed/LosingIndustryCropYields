...
LoI_maize.to_csv(
    params.geopandasDataDir + "LoI" + CROP + "Gap" + postfix + "Filtered.csv"
)
...
raw_data.iloc[LoI_maize["index"], raw_data.columns.get_loc("m_y2_change")] = LoI_maize[
    "m_y2_change"
].values
