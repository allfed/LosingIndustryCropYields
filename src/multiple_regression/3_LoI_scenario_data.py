...
totals = pd.DataFrame({'n_fertilizer':[118763000, 14477000],
...
for crop in crops:
     ...
     for column in year1_columns:
         ...
         LoI_data[crop][column_name] = calculate_year1(LoI_data[crop], column, Area_Data[crop], totals)
     #in phase 1, the total N available is the sum of available fertilizer and manure
     LoI_data[crop]['n_total_y1'] = LoI_data[crop]['n_fertilizer_y1'] + LoI_data[crop]['manure_LoI']
