...
wheat_yield = pd.read_pickle(params.inputDataDir + 'WHEACropYieldHighRes.pkl', compression='zip')
...
w_pesticides = pd.read_pickle(params.inputDataDir + 'WheatPesticidesHighRes.pkl', compression='zip')
