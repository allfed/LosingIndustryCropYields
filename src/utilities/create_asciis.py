...
if create_yield.startswith("y"):
    ...
    utilities.create5minASCII(
        fertilizer, "yield_kgPerHa", params.asciiDir + "yield_maiz"
    )

create_fertilizer_n = input(
    "Would you like to create fertilizer? (enter y/n): \n"
).lower()
...
create_fertilizer_p = input(
    "Would you like to create p fertilizer? (enter y/n): \n"
).lower()
...
create_pesticides = input(
    "Would you like to create wheat pesticides? (enter y/n): \n"
).lower()
if create_pesticides.startswith("y"):
    ...
    utilities.create5minASCII(
        pesticides, "total_H", params.asciiDir + "pesticidesWheat"
    )

create_pesticides = input(
    "Would you like to create corn pesticides? (enter y/n): \n"
).lower()
if create_pesticides.startswith("y"):
    print("Creating pesticides")
...
create_irrigation = input(
    "Would you like to create fraction irrigation that is reliant irrigation? (enter y/n): \n"
).lower()
if create_irrigation.startswith("y"):
    ...
    utilities.create5minASCII(
        irrigation, "frac_reliant", params.asciiDir + "irrigationReliantFraction"
    )

create_irrigation_total = input(
    "Would you like to create fraction cell area that is irrigated? (enter y/n): \n"
).lower()
if create_irrigation_total.startswith("y"):
    print("Creating irrigation total")

    irrigation_frac = pd.read_csv(
        params.geopandasDataDir + "FracIrrigationAreaHighRes.csv"
    )
    utilities.create5minASCII(
        irrigation_frac, "fraction", params.asciiDir + "irrigationAreaFraction"
    )

create_cropland_area = input(
    "Would you like to create fraction cell that is cropland? (enter y/n): \n"
).lower()
if create_cropland_area.startswith("y"):
    ...
    utilities.create5minASCII(
        cropland, "fraction", params.asciiDir + "croplandAreaFraction"
    )
...
create_LoI_cy2 = input(
    "Would you like to create maize LoI yield gap change for year 2? (enter y/n): \n"
).lower()
...
create_LoI_y2 = input(
    "Would you like to create LoI yield for year 2? (enter y/n): \n"
).lower()
if create_LoI_y2.startswith("y"):
    print("Creating LoI y2")
...
create_LoI_cy2 = input(
    "Would you like to create LoI yield change for year 2? (enter y/n): \n"
).lower()
if create_LoI_cy2.startswith("y"):
    print("Creating LoI y2")
