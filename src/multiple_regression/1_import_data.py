...
nutrients_kgha = pd.DataFrame().assign(fertN_kgha=fertilizer['n'], fertP_kgha=fertilizer['p']) * 10000
nutrients_kgha[['manN_applied_kgha', 'manN_produced_kgha']] = manure[['applied', 'produced']] /100
# compile a combined factor for N including both N from fertilizer and manure
nutrients_kgha['totN'] = nutrients_kgha['fertN_kgha'] + nutrients_kgha['manN_applied_kgha']
...
for crop in crops:
    ...
    data_raw[data_name] = {"lat": Yield[crop + '_yield'].loc[:, 'lats'],
